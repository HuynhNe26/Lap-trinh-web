...
<body>
    <div class="notification" id="notification">
        Sản phẩm của quý khách đã được thêm thành công vào giỏ hàng. Mời quý khách vào <a class="view-cart" href="./addgiohang.php">Xem giỏ hàng</a> để xem chi tiết
    </div>
    ...
    <div class="container" >
        ...
        <div class="view-cart">
            <a  href="addgiohang.php">Xem Giỏ Hàng</a>
        </div>
