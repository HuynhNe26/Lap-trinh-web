...
<div class="image-section">
    <img src="../image/BMW-7.webp" alt="BMW-7">
</div>
<div class="info-section">
    <h1 style="color:#0056b3">BMW-7</h1>
    <div class="price" style="font-weight: 600">Giá từ: ...&nbsp;VNĐ</div>
    <p style="font-weight:500; color:navy">[BMW - 7] Công nghệ hiện đại, tiết kiệm chi phí vượt trội!</p>
    <p>BMW - 7 không chỉ đẹp ấn tượng mà còn đầy tiện nghi, hiện đại, giúp bạn trải nghiệm sự thoải mái và an toàn.</p>
